            ...
            <div className="flex flex-col gap-4 w-full max-w-xs">
                ...
                {step === 3 && (
                    <div className="flex flex-col items-center gap-6">
                        ...
                        <button onClick={handleSignUp} disabled={!isNicknameValid} className={`w-full py-3 rounded-lg font-bold ${isNicknameValid ? 'bg-pink-500' : 'bg-neutral-800'}`}>회원가입 완료</button>
                    </div>
                )}
            </div>
        </div>
